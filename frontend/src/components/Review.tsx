...
const Review = ({
  ...
  return (
    <article
      className={`group bg-white/5 border border-white/6 rounded-[2rem] p-6 shadow-[0_24px_80px_-40px_rgba(15,23,42,0.9)] backdrop-blur-sm transition-transform duration-300 hover:-translate-y-1 ${className}`}
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.35em] text-sky-300">{source}</p>
        ...
        {stars ? (
          <div className="rounded-full bg-white/5 px-4 py-2 text-sm font-semibold tracking-wide text-sky-300 ring-1 ring-white/10">
