...
const Navbar = () => {
  return (
    <nav className="uppercase fixed top-0 left-0 right-0 px-8 py-4 flex items-center justify-between z-50 bg-linear-to-b from-black/60 to-transparent">
      {/* Left - Logo */}
      ...
      <div className="flex-1 flex justify-end gap-4">
        ...
        <button className="px-6 py-2 bg-primary text-text-primary rounded-lg hover:bg-primary-dark transition-all font-medium">
          Sign In
        </button>
      </div>
    </nav>
